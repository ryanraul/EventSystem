...
INSERT INTO TB_EVENT (name, description, start_Date, end_Date, start_Time, end_Time, email_Contact, amount_free_tickets, amount_payed_tickets, price_ticket, admin_user_id) 
   VALUES
      ...
      ( 'NLW2', 'For React learners', '2021-03-30', '2021-04-05', '07:00:00', '12:00:00', 'JA@email.com', 2, 4, 200, 1),
      ( 'TecnoFacens 2022', 'Projects presentation', '2021-04-01', '2021-04-10', '07:00:00', '12:00:00', 'JA@email.com', 2, 4, 200, 1);
